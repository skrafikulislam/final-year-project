  ...
  return (
    <div>
      <header class="sticky  top-4 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
        <nav
          class="relative max-w-[66rem] w-full bg-green-800 mt-8 rounded-[28px] py-3 ps-5 pe-2 md:flex md:items-center md:justify-between md:py-2 mx-2 lg:mx-auto"
          aria-label="Global"
        >
          ...
          >
            <div class="flex flex-col md:flex-row md:items-center md:justify-end py-2 md:py-0 md:ps-7">
              <Link
                to="/"
                class="py-3 ps-px sm:px-3 md:py-4 text-md text-white hover:text-neutral-300 focus:outline-none focus:text-neutral-300"
                href="../templates/agency/index.html"
                aria-current="page"
              >
                Home
              ...
              <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] py-3 ps-px sm:px-3 md:py-4">
                {/* Mobile Responsive Hamburger Menu Components*/}
