...
//           <h2 class="font-medium text-gray-600 text-2xl sm:text-4xl">
//             Contacts
//           </h2>
//         </div>
...
//             <img
//               class="hover:translate-x-6 duration-500 ease-in-out object-cover cursor-pointer rounded-2xl"
...
//           <div class="space-y-8 lg:space-y-16 bg-green-600 p-11 rounded-xl cursor-pointer hover:translate-y-6 duration-500">
//             <div>
//               <h3 class="mb-5 font-semibold text-gray-600 ">Our address</h3>

//               <div class="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
//                 <div class="flex gap-4">
//                   <svg
//                     class="flex-shrink-0 size-5 text-white"
...
//                     <address class="mt-1 text-white not-italic ">
//                       Tollyguange Kolkata
//                       <br />
//                       Near Netaji Khudghat Metro sStation
//                     </address>
//                   </div>
//                 </div>
//               </div>
...
//             <div>
//               <h3 class="mb-5 font-semibold text-gray-600 ">Our contacts</h3>
            ...
            <div>
              ...
              <div class="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
                ...
                <div class="flex gap-4">
                  ...
                  <div class="grow">
                    <p class="text-sm text-white ">Call us</p>
                    <p>
                      <a
                        class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 hover:before:bg-black focus:outline-none focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white"
                        href="mailto:example@site.so"
